 ...
 * @since 25-3-2016
 */
public class NameHistoryOfPlayer {
    ...
    public static  PreviousPlayerNameEntry[] getPlayerPreviousNamesByUsername(String username) throws IOException {
        return getPlayerPreviousNames(getPlayerUUID(username));
    }
    /**
